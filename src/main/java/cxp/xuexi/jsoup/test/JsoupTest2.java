...
public class JsoupTest2 {
     ...
     * @return Document
     */
    public static Document parseDocumentFromUrl() throws Exception{
        Document doc = null;
        try {
    ...
    public static Document parseDocumentFromFile(){
        File input = new File("E:\\Idea 2016.3.4 workspace\\springboot\\springboot3_class\\src\\main\\resources\\static\\product\\index.html");
        Document doc=null;
        try {
            //从文件加载Document文档
            ...
            Elements links = content.getElementsByTag("th");
